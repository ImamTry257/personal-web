        ...
        setTimeout(() => {
            ...
            function runModalLogin(){
                if(window.outerWidth < 993){
                    ...
                    $('ul.ul-menu').removeClass('d-flex flex-row')
                }else{
                    $("li#li-menu").show();
                    $('ul.ul-menu').addClass('d-flex flex-row')
                }
            }
            ...
            $(".nav-button").click(function(){
                ...
                $('div.menu-header').removeClass('click-menu')
                if($('div.menu-header').hasClass('click-menu')){
                    $('div.menu-header').css('','')
                    $('ul.ul-menu').addClass('d-flex justify-content-around flex-row');
                }else{
                    $('li#li-menu').css('position','relative')
                    $('li#li-menu').css('right','45px')
                    $('div.menu-header').addClass('click-menu')
                    $('ul.ul-menu').removeClass('d-flex justify-content-around flex-row');
                }
